                ...
                <div className="py-12 md:py-20">
                    ...
                    <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
                        <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
                            At Fluence, we make influencer marketing effortless. Our powerful suite
                            of tools is designed to help both brands and content creators thrive
                        </h2>
                    </div>
                    {/* Planet
                    ...
                    <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-2 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
                        <article>
                            ...
                            <p className="text-[15px] text-gray-400">
                                Easily find creators that match your brand’s vision and goals.
                            </p>
                        </article>
                        <article>
                            <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                            ...
                            <p className="text-[15px] text-gray-400">
                                Manage deals, track communication, and handle projects without the
                                chaos of multiple tools.
                            </p>
                        </article>
                        <article>
                            <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                            ...
                            <p className="text-[15px] text-gray-400">
                                Build profitable campaigns and turn your content collaborations into
                        ...
                        <article>
                            ...
                            <p className="text-[15px] text-gray-400">
                                Monitor campaign performance with easy-to-read metrics, ensuring
                                every collaboration drives measurable results.
                            </p>
                        </article>
                        {/* <article>
                            <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
